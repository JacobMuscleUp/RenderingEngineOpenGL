...
vec3 CalculateDirectionalLight(Material _material, vec2 _texCoords, vec3 _viewDir, vec3 _normal, vec3 _viewPos, DirectionalLight _dirLight) {
    // ambient
...
vec3 CalculatePointLight(Material _material, vec2 _texCoords, vec3 _viewDir, vec3 _normal, vec3 _fragPos, PointLight _ptLight) {
...
vec3 CalculateSpotLight(Material _material, vec2 _texCoords, vec3 _viewDir, vec3 _normal, vec3 _fragPos, SpotLight _spotLight) {
...
vec3 CalculateDirectionalLight(Material _material, vec3 _viewDir, vec3 _normal, vec3 _viewPos, DirectionalLight _dirLight) {
    // ambient
...
vec3 CalculatePointLight(Material _material, vec3 _viewDir, vec3 _normal, vec3 _fragPos, PointLight _ptLight) {
    vec3 lightDir = _ptLight.pos - _fragPos
        , unitLightDir = normalize(lightDir);
...
vec3 CalculateSpotLight(Material _material, vec3 _viewDir, vec3 _normal, vec3 _fragPos, SpotLight _spotLight) {
    vec3 lightDir = _spotLight.pos - _fragPos
        , unitLightDir = normalize(lightDir);
...
#elif defined(SHADING_TEXTURE_POM)
